...
export default function Dashboard() {
    ...
    const type = {
        Recurve: [
            "U10 18m (แข่งวันที่ 2-3/12/66)",
            "U12 30m (แข่งวันที่ 2-3/12/66)",
            "U15 30m (แข่งวันที่ 2-3/12/66)",
            "U18 30m (แข่งวันที่ 2-3/12/66)",
            "Open 30m (แข่งวันที่ 2-3/12/66)",
            "U18 50m (แข่งวันที่ 4-5/12/66)",
            "Open 70m (แข่งวันที่ 4-5/12/66)",
        ],
        Compound: [
            "U12 30m (แข่งวันที่ 2-3/12/66)",
            "U18 30m (แข่งวันที่ 2-3/12/66)",
